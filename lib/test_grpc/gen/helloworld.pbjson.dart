...
const AuthRequest$json = const {
  '1': 'AuthRequest',
  '2': const [
    const {'1': 'user', '3': 1, '4': 1, '5': 11, '6': '.org.harryng.dart.User', '10': 'user'},
  ],
};

/// Descriptor for `AuthRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List authRequestDescriptor = $convert.base64Decode('CgtBdXRoUmVxdWVzdBIqCgR1c2VyGAEgASgLMhYub3JnLmhhcnJ5bmcuZGFydC5Vc2VyUgR1c2Vy');
...
const User$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.org.harryng.dart.UserState', '10': 'state'},
  ],
};

/// Descriptor for `User`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userDescriptor = $convert.base64Decode('CgRVc2VyEg4KAmlkGAEgASgJUgJpZBIaCgh1c2VybmFtZRgCIAEoCVIIdXNlcm5hbWUSMQoFc3RhdGUYAyABKA4yGy5vcmcuaGFycnluZy5kYXJ0LlVzZXJTdGF0ZVIFc3RhdGU=');
...
const ChatMessage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.org.harryng.dart.MessageType', '10': 'type'},
    const {'1': 'message', '3': 5, '4': 1, '5': 12, '10': 'message'},
    const {'1': 'state', '3': 6, '4': 1, '5': 14, '6': '.org.harryng.dart.MessageState', '10': 'state'},
  ],
};

/// Descriptor for `ChatMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List chatMessageDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use chatSignalDescriptor instead')
const ChatSignal$json = const {
  '1': 'ChatSignal',
  '2': const [
    const {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.org.harryng.dart.MessageState', '10': 'state'},
  ],
};

/// Descriptor for `ChatSignal`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List chatSignalDescriptor = $convert.base64Decode('CgpDaGF0U2lnbmFsEjQKBXN0YXRlGAEgASgOMh4ub3JnLmhhcnJ5bmcuZGFydC5NZXNzYWdlU3RhdGVSBXN0YXRl');
